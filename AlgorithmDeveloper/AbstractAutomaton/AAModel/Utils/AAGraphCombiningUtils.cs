...
namespace AlgorithmDeveloper.AAModel.Model.Utils
{
    public sealed class CommonSubgraph
    {
        ...
        public AbstractAutomaton SubgraphFromA { get; }
        public AbstractAutomaton SubgraphFromB { get; }

        public CommonSubgraph(Dictionary<IBDVertex, IBDVertex> mapping, AbstractAutomaton subA, AbstractAutomaton subB)
        {
            MappingAtoB = mapping;
            SubgraphFromA = subA;
            SubgraphFromB = subB;
    ...
    {
        public static string BuildCommonSubgraphsReport(AbstractAutomaton aa1, AbstractAutomaton aa2, bool strictLabels = false, int resultLimit = 5)
        {
        ...
        private static string FormatSignificantVerticesList(AbstractAutomaton model)
        {
            var ids = GetSignificantIdsInTraversalOrder(model);
            return string.Join(", ", ids);
        }

        private static List<string> GetSignificantIdsInTraversalOrder(AbstractAutomaton model)
        {
        ...
        public static List<CommonSubgraph> FindMaximumCommonSubgraphs(AbstractAutomaton a, AbstractAutomaton b, bool strictLabels = false, int resultLimit = 5)
        {
        ...
        private static Dictionary<string, List<IBDVertex>> EnumerateNextChains(AbstractAutomaton model)
        {
        ...
        private static List<string> SortKeysByAppearance(IEnumerable<string> keys, AbstractAutomaton a, AbstractAutomaton b)
        {
        ...
        private static (List<IBDVertex> aList, List<IBDVertex> bList) ExpandWithMatchingBranchHeads(AbstractAutomaton a, AbstractAutomaton b, List<IBDVertex> baseA, List<IBDVertex> baseB)
        {
        ...
        private static AbstractAutomaton BuildSubgraph(AbstractAutomaton original, HashSet<IBDVertex> nodes)
        {
        ...
        private static IBDVertex? BuildJumpChainFrom(AbstractAutomaton model, IBDVertex startCopy, IBDVertex? origNext, Dictionary<IBDVertex, IBDVertex> map)
        {
