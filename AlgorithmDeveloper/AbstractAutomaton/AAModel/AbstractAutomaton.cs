...
namespace AlgorithmDeveloper.AAModel
{
    ...
    /// </summary>
    public class AbstractAutomaton : IEquatable<AbstractAutomaton>
    {
        #region Поля
        ...
        public bool Equals(AbstractAutomaton? other)
        {
        ...
        {
            return obj is AbstractAutomaton other && Equals(other);
        }
