...
namespace AlgorithmDeveloper.AlgoDev.Model.Vertices
{
    ...
    public interface IBDVertex
    {
        ...
        IBDVertex? GetNext(AbstractAutomaton? model = null);
    }
    ...
    public abstract class BDVertex : IBDVertex, IGraphFigure
    {
        ...
        public abstract IBDVertex? GetNext(AbstractAutomaton? model = null);
        ...
        */
        ...
        public virtual void UpdateGraphMetrics(AbstractAutomaton model)
        {
            _children.Clear();
            switch (this)
            {
