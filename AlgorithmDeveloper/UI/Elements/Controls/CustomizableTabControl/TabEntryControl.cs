...
namespace AlgorithmDeveloper.UI.Elements.Controls.CustomizableTabControl
{
    ...
    public partial class TabEntryControl : UserControl
    {
        ...
        public CustomizableTabControl? TabControl { get; private set; }
        ...
        public TabEntryControl(CustomizableTabControl tabControl, TabPage tabPage) : this()
        {
        ...
        public void UpdateState()
        {
            ...
            // Новые запреты из CustomizableTabControl (доступны только если есть TabControl и страница)
