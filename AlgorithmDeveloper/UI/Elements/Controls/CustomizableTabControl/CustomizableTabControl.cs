...
namespace AlgorithmDeveloper.UI.Elements.Controls.CustomizableTabControl
{
    ...
    public class CustomizableTabControl : TabControl, IExtenderProvider
    {
        #region Конструкция

        /// <summary>
        /// Инициализирует новый экземпляр класса CustomizableTabControl
        /// </summary>
        public CustomizableTabControl()
        {
