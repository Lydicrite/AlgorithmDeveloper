...
namespace AlgorithmDeveloper.UI.Elements.Controls.CustomizableTabControl
{
    /// <summary>
    /// Связка FlowLayoutPanel с CustomizableTabControl для синхронизации списка вкладок и управляющих элементов
    /// </summary>
    public class TabFlowBinder
    {
        private readonly FlowLayoutPanel _panel;
        private readonly CustomizableTabControl _tabControl;
        ...
        public TabFlowBinder(FlowLayoutPanel panel, CustomizableTabControl tabControl)
        {
        ...
        /// </summary>
        public static TabFlowBinder Attach(FlowLayoutPanel panel, CustomizableTabControl tabControl)
        {
        ...
        private IEnumerable<TabPage> GetAllKnownPages()
        {
            ...
            try
            {
                var field = typeof(CustomizableTabControl).GetField("_TabPages", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
