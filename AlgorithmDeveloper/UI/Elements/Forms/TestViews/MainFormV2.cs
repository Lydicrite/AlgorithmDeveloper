    ...
    public partial class MainFormV2 : Form
    {
        ...
        private void InitVisualizationSettingsBindings()
        {
            try
            {
                ...
                _drawJumpPoints.CheckedChanged += _drawJumpPoints_CheckedChanged;
            }
            catch { }
        }
        ...
        {
            _drawJumpPoints.FlatAppearance.BorderColor = _drawJumpPoints.Checked ? Color.FromArgb(0, 170, 0) : Color.Maroon;
            
            _algoController1?.SetShowJumpPoints(_drawJumpPoints.Checked);
            _algoController2?.SetShowJumpPoints(_drawJumpPoints.Checked);
            _algoController3?.SetShowJumpPoints(_drawJumpPoints.Checked);
        }
