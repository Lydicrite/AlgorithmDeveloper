...
namespace AlgorithmDeveloper.AlgorithmModel.TransitionSystem
{
    ...
    public static class TransitionSystemBuilder
    {
        ...
        /// </summary>
        public static List<TransitionFormula> BuildAll(AlgoModel model, TransitionBuildMode mode = TransitionBuildMode.NoParadox)
        {
        ...
        /// </summary>
        private static HashSet<IBDVertex> CollectReachableStarts(AlgoModel model)
        {
