...
namespace AlgorithmDeveloper.AlgorithmModel.LAS.RandomLASGenerator
{
    ...
    public class LASValidator
    {
        ...
        public bool IsValid(string lasString)
        {
            ...
            try
            {
                return LASParser.TryParse(lasString, out AlgoModel? model, out List<ParsingError> errors);
            }
            catch
            {
                return false;
        ...
        public bool TryValidate(string las, out AlgoModel? model, out string errorMessage)
        {
        ...
        public AlgoModel Parse(string lasString)
        {
