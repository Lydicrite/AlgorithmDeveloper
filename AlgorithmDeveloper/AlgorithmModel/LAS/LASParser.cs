...
{
    /// <summary>
    /// Парсер логических схем алгоритмов (ЛСА) в объекты <see cref="AlgoModel"/>.
    ...
    internal static class LASParser
    {
        ...
        /// <summary>
        /// Преобразует входную строку <paramref name="input"/> в объект <see cref="AlgoModel"/>.
        /// </summary>
        /// <param name="input">Входная строка с ЛСА.</param>
        /// <returns>Объект <see cref="AlgoModel"/>, заполненный по указанному во входной строке алгоритму</returns>
        /// <exception cref="ParsingAggregateException">Возникает при обнаружении ошибок парсинга.</exception>
        public static AlgoModel Parse(string input)
        {
        ...
        /// <summary>
        /// Проверяет возможность преобразования входной строки <paramref name="input"/> в объект <see cref="AlgoModel"/>
        ...
        public static bool TryParse(string input, out AlgoModel? model, out List<ParsingError> errors)
        {
            model = null;
        ...
        /// <returns><see langword="true"/>, если парсинг прошел без ошибок; иначе <see langword="false"/>.</returns>
        public static bool TryParse(string input, out AlgoModel? model, out ParsingAggregateException? exception)
        {
            model = null;
            exception = null;
            try
        ...
        /// <br></br> Созданные элементы добавляются в объект <see cref="AlgoModel"/>.
        /// </summary>
        /// <param name="model">Объект <see cref="AlgoModel"/>, в который добавляются созданные элементы.</param>
        ...
        private static IBDVertex? ParseElement(ParserContext ctx, AlgoModel model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
        ...
        private static IBDVertex? ParseSubAlgorithm(ParserContext ctx, AlgoModel model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
        ...
        private static EndVertex? HandleEndVertex(AlgoModel model, int pos, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
            if (model.End != null)
            {
        ...
        /// </summary>
        /// <param name="model">Объект <see cref="AlgoModel"/> для проверки.</param>
        /// <param name="errors">Ссылка на список ошибок парсера.</param>
        private static void ValidateStartEndUniqueness(AlgoModel model, ref List<ParsingError> errors)
        {
        ...
        /// <param name="model">Объект <see cref="AlgoModel"/> для проверки.</param>
        /// <param name="errors">Ссылка на список ошибок парсера.</param>
        private static void ValidateConditionalVertices(AlgoModel model, ref List<ParsingError> errors)
        {
