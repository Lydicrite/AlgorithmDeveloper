...
namespace AlgorithmDeveloper.AlgorithmModel.LAS
{
    ...
    public static class LASGenerator
    {
        ...
        /// </summary>
        public static string Generate(AlgoModel model, out string verboseLog, bool enableLogging = false)
        {
        ...
        {
            private readonly AlgoModel _model;
            ...
            public GenCtx(AlgoModel model, bool enableLogging)
            {
                _model = model;
