...
namespace AlgorithmDeveloper.Abstractions.TransitionSystem
{
    ...
    public static class TransitionSystemBuilder
    {
        ...
        /// </summary>
        public static List<TransitionFormula> BuildAll(AbstractAutomata model, TransitionBuildMode mode = TransitionBuildMode.NoParadox)
        {
            ...
            var sortedFormulas = formulasByStart.Values
                .Select(f => new TransitionFormula(
                    f.YStart,
                    f.Conditions.OrderBy(c => c.YTo, comparer)
                ))
        ...
        /// </summary>
        private static HashSet<IBDVertex> CollectReachableStarts(AbstractAutomata model)
        {
