namespace AlgorithmDeveloper.Abstractions.AAModel.Vertices.Geometry
{
    /// <summary>
    ...
    public interface IFigure
    {
        ...
        /// </summary>
        static int HalfWidth { get { return AlgorithmDeveloper.UI.Elements.Controls.Viewports.VisualizationSettings.FigureHalfWidthRounded; } }
        /// <summary>
        /// Полувысота вершины (одинаковая для всех вершин).
        /// </summary>
        static int HalfHeight { get { return AlgorithmDeveloper.UI.Elements.Controls.Viewports.VisualizationSettings.FigureHalfHeightRounded; } }
        /// <summary>
        ...
        /// <summary>
        /// Флаг, указывающий, является ли фигура активной (подсвеченной) в данный момент.
        /// </summary>
