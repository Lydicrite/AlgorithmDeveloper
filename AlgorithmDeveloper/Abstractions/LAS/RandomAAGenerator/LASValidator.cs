...
namespace AlgorithmDeveloper.Abstractions.LAS.RandomAAGenerator
{
    ...
    public class LASValidator
    {
        ...
        public bool IsValid(string lasString)
        {
            ...
            try
            {
                return LASParser.TryParse(lasString, out AbstractAutomata? model, out List<ParsingError> errors);
            }
            catch
            {
                return false;
        ...
        public bool TryValidate(string las, out AbstractAutomata? model, out string errorMessage)
        {
        ...
        public AbstractAutomata Parse(string lasString)
        {
