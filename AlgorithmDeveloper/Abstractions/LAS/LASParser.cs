...
{
    /// <summary>
    /// Парсер логических схем алгоритмов (ЛСА) в объекты <see cref="AbstractAutomata"/>.
    ...
    public static class LASParser
    {
        ...
        /// <summary>
        /// Преобразует входную строку <paramref name="input"/> в объект <see cref="AbstractAutomata"/>.
        /// </summary>
        /// <param name="input">Входная строка с ЛСА.</param>
        /// <returns>Объект <see cref="AbstractAutomata"/>, заполненный по указанному во входной строке алгоритму</returns>
        /// <exception cref="ParsingAggregateException">Возникает при обнаружении ошибок парсинга.</exception>
        public static AbstractAutomata Parse(string input)
        {
        ...
        /// <summary>
        /// Проверяет возможность преобразования входной строки <paramref name="input"/> в объект <see cref="AbstractAutomata"/>
        ...
        public static bool TryParse(string input, out AbstractAutomata? model, out List<ParsingError> errors)
        {
            model = null;
        ...
        /// <returns><see langword="true"/>, если парсинг прошел без ошибок; иначе <see langword="false"/>.</returns>
        public static bool TryParse(string input, out AbstractAutomata? model, out ParsingAggregateException? exception)
        {
            model = null;
            exception = null;
            try
        ...
        public static bool TryParse(string input, out List<ParsingError> errors)
        {
            ...
            errors = new List<ParsingError>();
            var parsedPositions = new Dictionary<int, bool>();
            AbstractAutomata? tempModel = null;
            ...
            try
            {
                ...
                tempModel = new AbstractAutomata();
        ...
        /// <br></br> Созданные элементы добавляются в объект <see cref="AbstractAutomata"/>.
        /// </summary>
        /// <param name="model">Объект <see cref="AbstractAutomata"/>, в который добавляются созданные элементы.</param>
        ...
        (
            ParserContext ctx, AbstractAutomata model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions,
        ...
        private static IBDVertex? ParseElement(ParserContext ctx, AbstractAutomata model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
        ...
        (
            AbstractAutomata model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions,
        ...
        private static IBDVertex? ParseSubAlgorithm(ParserContext ctx, AbstractAutomata model, List<string> tokens, ref int position, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
        ...
        private static EndVertex? HandleEndVertex(AbstractAutomata model, int pos, ref Dictionary<int, bool> parsedPositions, ref List<ParsingError> errors)
        {
            if (model.End != null)
            {
        ...
        private static OperatorVertex CreateOperatorVertex(ParserContext ctx, AbstractAutomata model, int pos, ref Dictionary<int, bool> parsedPositions, int index, ref List<ParsingError> errors)
        {
        ...
        private static JumpPoint CreateJumpPoint(ParserContext ctx, AbstractAutomata model, int pos, ref Dictionary<int, bool> parsedPositions, int index, ref List<ParsingError> errors)
        {
        ...
        /// </summary>
        /// <param name="model">Объект <see cref="AbstractAutomata"/> для проверки.</param>
        /// <param name="errors">Ссылка на список ошибок парсера.</param>
        private static void ValidateStartEndUniqueness(AbstractAutomata model, ref List<ParsingError> errors)
        {
        ...
        /// <param name="model">Объект <see cref="AbstractAutomata"/> для проверки.</param>
        /// <param name="errors">Ссылка на список ошибок парсера.</param>
        private static void ValidateConditionalVertices(AbstractAutomata model, ref List<ParsingError> errors)
        {
