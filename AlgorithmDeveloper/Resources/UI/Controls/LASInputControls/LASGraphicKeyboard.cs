...
namespace AlgorithmDeveloper.Resources.UI.Controls.LASInputControls
{
    public partial class LASGraphicKeyboard : UserControl
    {
        ...
        {
            if (root is TextBoxBase tbRoot && (tbRoot is LASInputTextBox || tbRoot is AlgorithmDeveloper.Resources.UI.Controls.LASInputRichTextBox))
                yield return tbRoot;
