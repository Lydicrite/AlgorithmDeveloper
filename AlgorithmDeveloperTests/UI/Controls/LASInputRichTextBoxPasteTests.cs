...
using AlgorithmDeveloper.Resources.UI.Controls;
using System;
...
namespace AlgorithmDeveloperTests.UI.Controls
{
    [TestClass]
        ...
        public void PasteRtfWithColorResetsToControlStyle()
        {
            RunInSta(() =>
            {
                ...
                using (rtb)
                {
                    ...
                    string rtf = "{\\rtf1\\ansi\\deff0{\\fonttbl{\\f0 Segoe UI;}{\\f1 Times New Roman;}}{\\colortbl;\\red255\\green0\\blue0;}\\f1\\fs28\\cf1 Hello \\cf0 world}";
                    Clipboard.Clear();
